...
exports.register = function (pack, options, next) {
    ...
    pack.ext('onPreAuth', function (request, callback) {
        ...
        var decorate = function (err) {
            ...
            request.session.reset = function () {
                ...
                request.session._sst = startTime;
                request.session._store = {};
        ...
        var prepare = function () {
            ...
            if (request.session._isLazy) {
                ...
                Object.keys(request.session).forEach(function (key) {
                    ...
                    if (['id', '_sst', '_store', '_isModified', '_isLazy', 'reset', 'get', 'set', 'clear', 'touch', 'flash', 'lazy'].indexOf(key) === -1 &&
                        key[0] !== '_' &&
