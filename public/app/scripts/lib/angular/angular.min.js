/*
 ...
 License: MIT
*/
(function(Y,T,s){'use strict';function P(a){return function(){for(var b=arguments[0],c=1,b="["+(a?a+":":"")+b+"] http://errors.angularjs.org/undefined/"+(a?a+"/":"")+b;c<arguments.length;c++)b=b+(1==c?"?":"&")+"p"+(c-1)+"="+encodeURIComponent("function"==typeof arguments[c]?arguments[c].toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof arguments[c]?"undefined":"string"!=typeof arguments[c]?JSON.stringify(arguments[c]):arguments[c]);return Error(b)}}function mb(a){if(null==a||ya(a))return!1;
...
a.trim():a}:function(a){return w(a)?a.replace(/^\s*/,"").replace(/\s*$/,""):a}}();Da=9>Q?function(a){a=a.nodeName?a:a[0];return a.scopeName&&"HTML"!=a.scopeName?Ea(a.scopeName+":"+a.nodeName):a.nodeName}:function(a){return a.nodeName?a.nodeName:a[0].nodeName};var Kc=/[A-Z]/g,Id={full:"1.2.0-448bd14",major:1,minor:2,dot:0,codeName:"ferocious-twitch"},Oa=S.cache={},Za=S.expando="ng-"+(new Date).getTime(),Oc=1,xc=Y.document.addEventListener?function(a,b,c){a.addEventListener(b,c,!1)}:function(a,b,c){a.attachEvent("on"+
