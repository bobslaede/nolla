!function (b) {
  ...
  a.prototype = {constructor: a, init: function (d) {
    ...
    if (this.options.size == "auto") {
      function o() {
        ...
        e.css({"max-height": menuHeight + "px", "overflow-y": "auto", "min-height": minHeight + "px"})
      }
      ...
      if (this.options.size && this.options.size != "auto" && e.find("li" + d).length > this.options.size) {
        ...
        e.css({"max-height": menuHeight + "px", "overflow-y": "auto"})
      }
    }
    ...
    this.$newElement.css({position: "absolute", top: d + "px", left: c + "px"})
  }, refresh: function () {
    this.reloadLi();
    this.render();
    this.setSize();
    ...
    this.$newElement.on("click", "li a", function (j) {
      var g = b(this).parent().index(), i = b(this).parent(), d = i.parents(".bootstrap-select"), h = c.$element.val();
      if (c.multiple) {
        j.stopPropagation()
      }
      j.preventDefault();
  ...
  b.fn.selectpicker = function (e, f) {
    ...
    var d = this.each(function () {
      if (b(this).is("select")) {
        var l = b(this), k = l.data("selectpicker"), h = typeof e == "object" && e;
        if (!k) {
  ...
  b.fn.selectpicker.defaults = {style: null, size: "auto", title: null, selectedTextFormat: "values", noneSelectedText: "Nothing selected", width: null, container: false, hideDisabled: false};
